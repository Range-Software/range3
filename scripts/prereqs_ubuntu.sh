...
DEBIAN_FRONTEND=noninteractive apt-get install -y pkg-config build-essential alien openssh-client rpm qt6-default libavutil-dev libavformat-dev libswscale-dev libavdevice-dev ffmpeg
