...
DEBIAN_FRONTEND=noninteractive apt-get install -y pkg-config build-essential alien openssh-client rpm qtbase5-dev qtpdf5-dev libavutil-dev libavformat-dev libswscale-dev libavdevice-dev ffmpeg
