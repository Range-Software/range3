...
const RBoundaryConditionDesc boundaryConditionDesc [] =
{
    ...
    { "bc-particle_concentration", "Particle concentration", false, true, true, true, true, false, false, R_PROBLEM_CONTAMINANT },
    { "bc-particle_rate", "Particle rate", false, false, true, true, true, true, false, R_PROBLEM_CONTAMINANT },
