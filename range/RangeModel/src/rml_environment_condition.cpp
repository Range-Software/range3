...
const REnvironmentConditionDesc environmentConditionDesc [] =
{
    ...
    { "ec-temperature", "Temperature",
      R_PROBLEM_ACOUSTICS | R_PROBLEM_CONTAMINANT | R_PROBLEM_ELECTROSTATICS | R_PROBLEM_FLUID | R_PROBLEM_HEAT | R_PROBLEM_RADIATIVE_HEAT | R_PROBLEM_FLUID_HEAT | R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL | R_PROBLEM_POTENTIAL | R_PROBLEM_WAVE },
    { "ec-custom", "Custom",
      R_PROBLEM_NONE }
};
