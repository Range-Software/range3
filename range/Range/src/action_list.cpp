...
void ActionList::processAvailability(void)
{
    ...
    if (!selectedModelIDs.empty())
    {
        ...
        this->getAction(ACTION_GEOMETRY_VECTOR_FIELD_EDIT)->setEnabled(Session::selectedModelsHasEntities(R_ENTITY_GROUP_VECTOR_FIELD));
        this->getAction(ACTION_GEOMETRY_SCALAR_FIELD_CREATE)->setEnabled(true);
        this->getAction(ACTION_GEOMETRY_SCALAR_FIELD_EDIT)->setEnabled(Session::selectedModelsHasEntities(R_ENTITY_GROUP_SCALAR_FIELD));
        this->getAction(ACTION_GEOMETRY_STREAM_LINE_CREATE)->setEnabled(true);
        this->getAction(ACTION_GEOMETRY_STREAM_LINE_EDIT)->setEnabled(Session::selectedModelsHasEntities(R_ENTITY_GROUP_STREAM_LINE));
        this->getAction(ACTION_GEOMETRY_CUT_CREATE)->setEnabled(true);
        this->getAction(ACTION_GEOMETRY_CUT_EDIT)->setEnabled(Session::selectedModelsHasEntities(R_ENTITY_GROUP_CUT));
        this->getAction(ACTION_GEOMETRY_ISO_CREATE)->setEnabled(true);
        this->getAction(ACTION_GEOMETRY_ISO_EDIT)->setEnabled(Session::selectedModelsHasEntities(R_ENTITY_GROUP_ISO));
