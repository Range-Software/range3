...
void ActionDefinition::generateActionDescList(QList<ActionDefinitionItem> &actionDesc)
{
    ...
    actionDesc.push_back(ActionDefinitionItem(ACTION_SESSION_NEW, ACTION_GROUP_SESSION, "New Session", "Create a new session.", "Ctrl+Alt+N", ":/icons/file/pixmaps/range-project_new.png", &Action::onSessionNew));
    actionDesc.push_back(ActionDefinitionItem(ACTION_SESSION_OPEN, ACTION_GROUP_SESSION, "Open Session", "Open previously saved session.", "Ctrl+Alt+O", "", &Action::onSessionOpen));
    actionDesc.push_back(ActionDefinitionItem(ACTION_SESSION_SAVE, ACTION_GROUP_SESSION, "Save Session", "Save current session.", "Ctrl+Alt+S", "", &Action::onSessionSave));
    actionDesc.push_back(ActionDefinitionItem(ACTION_SESSION_SAVE_AS, ACTION_GROUP_SESSION, "Save Session As", "Save current session under different filename.", "Ctrl+Alt+Shift+S", "", &Action::onSessionSaveAs));
    actionDesc.push_back(ActionDefinitionItem(ACTION_SESSION_CLOSE, ACTION_GROUP_SESSION, "Close Session", "Close current session.", "Ctrl+Alt+W", "", &Action::onSessionClose));
    actionDesc.push_back(ActionDefinitionItem(ACTION_MODEL_NEW, ACTION_GROUP_MODEL, "New Model", "Create a new empty model.", "Ctrl+N", ":/icons/file/pixmaps/range-new.svg", &Action::onModelNew));
